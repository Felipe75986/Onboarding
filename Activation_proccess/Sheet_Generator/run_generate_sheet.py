...
from sheet_generator.filler import fill_onboarding_devices, fill_onboarding_metadata
from sheet_generator.folder import ensure_site_folder
from sheet_generator.google_client import build_drive, build_sheets
...
def main():
    ...
    fill_onboarding_metadata(sheets, clone["id"], inputs)
    fill_onboarding_devices(sheets, clone["id"], inputs)
